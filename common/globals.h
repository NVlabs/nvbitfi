...
const char * instTypeNames[NUM_ISA_INSTRUCTIONS] = {
 ...
 "FMUL32I", "FSET", "FSETP", "FSWZADD", "IPA", "MUFU", "RRO", "DADD", "DFMA",
 "DMNMX", "DMUL", "DSET", "DSETP", "HADD2", "HADD2_32I", "HFMA2", "HFMA2_32I",
 "HMUL2", "HMUL2_32I", "HSET2", "HSETP2", "IDP", "BFE", "BFI", "FLO", "IADD",
...
int fp32Inst[] = {
 FADD, FADD32I, FCMP, FFMA, FFMA32I, FMNMX, FMUL, FMUL32I, FSET, FSWZADD, IPA, DSET
 };
...
int noDestInst[] = {
 ST, STG, STL, STS, RED, CCTL, CCTLL, MEMBAR, CCTLT, SURED, SUST,
 // Control Instructions
 BRA, BRX, JMP, JMX, SSY, SYNC, CAL, JCAL, PRET, RET, BRK, PBK, CONT, PCNT, EXIT, PEXIT, LONGJMP, PLONGJMP, KIL, BPT, IDE, RAM, RTT, SAM,
 // Miscellaneous Instructions
 BSSY, BSYNC, // no general purpose register or predicate register as destination
 NOP, BAR, R2B, DEPBAR, SETCRSPTR, SETLMEMBASE
 };
...
int otherInst[] = {
 ...
 IDP, BFE, BFI, FLO, IADD, IADD3, IADD32I, ICMP, IMAD, IMAD32I, IMADSP, IMNMX, IMUL, IMUL32I, ISCADD, ISCADD32I, ISET, LEA, LOP, LOP3, LOP32I, POPC, SHF, SHL, SHR, XMAD,
 // MMA instructions
 IMMA, HMMA,
 // Video Instructions
 ...
 ATOM, ATOMS, SUATOM,
 // Miscellaneous Instructions
 CS2R, S2R, LEPC, B2R, VOTE, GETCRSPTR, GETLMEMBASE
 }; 
